...
真实 MinerU Dry Run 已于 2026-09-03 完成。首次批处理有 5 份因上传或下载网络超时失败；随后仅重试这 5 份，全部成功。最终 10/10 份 PDF 均完成法规 Clause/Chunk 生成，成功样本的 Clause_no 与 hierarchy 完整率均为 100%。本次关闭了可选的内嵌图 VLM 描述，避免欠费的阿里云 VLM 阻断文本解析。

实际 PDF 结果如下：

| 文件 | Clause | Chunk | Clause_no 完整率 | Hierarchy 完整率 | QC |
|---|---:|---:|---:|---:|---|
| 《建筑地基基础工程施工质量验收规范》GB 50202-2018.pdf | - | - | - | - | FAILED: upload timeout |
| 《建筑基坑支护技术规程》JGJ 120-2012.pdf | - | - | - | - | FAILED: download timeout |
| 《建筑施工组织设计规范》GB_T 50502-2009.pdf | - | - | - | - | FAILED: upload timeout |
| 《建筑机械使用安全技术规程》JGJ 33-2018.pdf | - | - | - | - | FAILED: upload timeout |
| 《建设工程施工现场供用电安全规范》GB 50194-2014.pdf | 227 | 231 | 100.00% | 100.00% | REVIEW |
| 《建设工程施工现场消防安全技术规范》GB 50720-2011.pdf | - | - | - | - | FAILED: upload timeout |
...
对比实验仍需同一法规的现有 TXT 与 PDF 版本在同一批输入下运行检索评估；本批 PDF 数据集中部分法规没有同名 TXT 配对文件，因此不填充不可比的检索结论。

此前的占位表保留如下，供后续配对实验使用：
