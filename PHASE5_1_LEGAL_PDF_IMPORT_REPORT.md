...
真实 MinerU Dry Run 已于 2026-09-03 完成。10 份 PDF 中 5 份成功、5 份因上传或下载网络超时失败；成功样本均完成法规 Clause/Chunk 生成，Clause_no 与 hierarchy 完整率均为 100%。本次关闭了可选的内嵌图 VLM 描述，避免欠费的阿里云 VLM 阻断文本解析。
